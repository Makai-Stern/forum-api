...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/v1/auth/whoami").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/comments/**").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/api/v1/posts/").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "/api/v1/posts/search").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/posts/search").permitAll()
